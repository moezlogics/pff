cat > /home/pff-api/htdocs/api.pff.org.pk/ecosystem.config.js << 'SCRIPT'
/**
...
module.exports = {
  apps: [
    {
      name: "medusa-backend",
      cwd: "/home/pff-api/htdocs/api.pff.org.pk",
      ...
      error_file: "/home/pff-api/htdocs/api.pff.org.pk/logs/medusa-error.log",
      out_file: "/home/pff-api/htdocs/api.pff.org.pk/logs/medusa-out.log",
      merge_logs: true,
      time: true
    }
  ]
...
mkdir -p /home/pff-api/htdocs/api.pff.org.pk/logs
