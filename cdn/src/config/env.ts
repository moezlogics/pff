...
export const env = {
    ...
    CDN_PUBLIC_URL: process.env.CDN_PUBLIC_URL || "http://localhost:8011",
    ...
    CORS_ORIGINS: (process.env.CORS_ORIGINS || "http://localhost:8010,http://localhost:8012,http://localhost:8011")
        .split(",")
        .map((o) => o.trim()),
