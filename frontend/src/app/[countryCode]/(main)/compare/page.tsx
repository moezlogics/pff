...
export const metadata: Metadata = {
  ...
  description:
    "Side-by-side comparison of product specifications, prices and features.",
...
export default async function ComparePage({
  ...
  // 1. Filter by comparable === true
  const comparableProducts = rawProducts.filter(
    (p) => (p.metadata as any)?.comparable === true || (p.metadata as any)?.comparable === "true"
  )
      ...
      <div className="container-anvogue py-16 md:py-24 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-sm text-ink/60 mb-6">
            Compare products side by side. Add products from the shop to start comparing their details and specifications.
          </p>
          <Link
