...
const PREMIUM_SUGGESTIONS: SuggestionCard[] = [
  {
    title: "National & Shan Spices",
    subtitle: "Local recipe mixes & masala",
    icon: "ph-bold ph-hash",
    prompt: "Show me Shan and National spices in stock",
  },
  {
    title: "Monthly Grocery Pack",
    subtitle: "Top essential bundles",
    icon: "ph-bold ph-basket",
    prompt: "What is the best monthly grocery package under 10,000 PKR?",
  },
  {
    title: "Organic & Sugar-free",
    subtitle: "Healthy dietary choices",
    icon: "ph-bold ph-leaf",
    prompt: "Show me organic or sugar-free food products",
  },
  {
  ...
  },
  {
    ...
    subtitle: "Farm-fresh daily arrivals",
    icon: "ph-bold ph-carrot",
    prompt: "What fresh fruits and vegetables do you have in stock?",
  },
  {
...
function getFollowUps(content: string, meta: AssistantMeta | null): string[] {
  ...
  } else if (has("spices", "masala", "national", "shan")) {
    add("Show spices & recipe mixes")
    add("Show organic items")
    add("Latest grocery arrivals")
  } else {
    add("Grocery packs under 5,000")
    add("Show National spices")
    add("Latest grocery arrivals")
    add("Talk to a human")
  }
    ...
    <>
      ...
      {!open && showTeaser && (
        ...
        >
          ...
          >
            Need help finding groceries? Ask me!
          </span>
          <button
            type="button"
            onClick={(e) => {
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-3.5 relative z-10">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        Product details, comparison, order tracking, ya grocery recommendations ke mutabiq puchen.
                      </p>
                    </div>
                  </div>
                </div>
