      ...
      <div className="relative overflow-hidden rounded-base bg-transparent">
        ...
        {(isUpcoming || (isSale && cheapestPrice?.percentage_diff)) && (
          <div className="absolute top-1 left-1 flex flex-col gap-0.5 z-[1] pointer-events-none">
            {isUpcoming && (
              <span className="inline-flex items-center justify-center text-[6.5px] leading-none font-bold uppercase tracking-wider bg-amber-500 text-white px-[4px] py-[2px] rounded-[1.5px] shadow-sm">
                Coming Soon
              </span>
            )}
