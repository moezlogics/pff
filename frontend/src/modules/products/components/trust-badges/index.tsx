...
const BADGE_CATALOG: Badge[] = [
  ...
  },
  {
    ...
    sub: "Manufacturer warranty",
    detail:
      "Backed by a full 1-year manufacturer warranty covering production defects, internal failure, or malfunction beyond normal wear. Visit any authorised service centre with your invoice for free repairs or replacement during the warranty period.",
  },
  {
    id: "warranty_2y",
    icon: "ph-shield-star",
