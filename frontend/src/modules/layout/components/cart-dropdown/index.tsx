      ...
      <Popover className="relative h-full">
        <PopoverButton className="h-full flex items-center outline-none">
          <LocalizedClientLink
            ...
            className="relative w-10 h-10 flex items-center justify-center rounded-full hover:bg-header-hover text-header-fg hover:text-header-accent transition-all duration-200 hover:scale-[1.05]"
          >
