  ...
  return (
    ...
    >
      ...
      <div className="small:hidden bg-header border-b border-header-line shadow-sm">
        {/* Row 1 — hamburger · logo · search · cart (56px) */}
          ...
          <Suspense
            fallback={
              <LocalizedClientLink
                href="/cart"
                aria-label="Cart"
                className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-header-hover text-header-fg hover:text-header-accent transition-all active:scale-90"
              >
