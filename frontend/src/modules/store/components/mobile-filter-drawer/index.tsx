  ...
  return (
    <>
      <button
        ...
        className="small:hidden inline-flex items-center gap-2 h-10 px-5 rounded-full border border-line text-sm font-semibold text-ink bg-bg shadow-soft hover:bg-surface transition-all active:scale-95"
      ...
      {open && (
        <>
          <div
            className="fixed inset-0 z-[100] bg-ink/35 backdrop-blur-[2px] transition-opacity duration-300 small:hidden"
            onClick={() => setOpen(false)}
            aria-hidden
          />
          <aside
            className="fixed top-0 right-0 h-[100dvh] w-[88vw] max-w-[360px] bg-bg z-[101] flex flex-col shadow-pop border-l border-line transition-transform duration-300 transform translate-x-0 small:hidden"
